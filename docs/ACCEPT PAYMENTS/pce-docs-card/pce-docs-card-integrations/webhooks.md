...
## 5.1. Setup for Webhook Subscription

<br />

1. Navigate to the Webhooks section in the PM portal
   2. Enter the URL you want to configure as endpoint and create the webhook.
      3. Upon creation, a subscription confirmation message will be sent to the configured URL.
         <br />
         Sample for the subscription confirmation message
         <br />
         ```
         ```
         4. Fetch the value of “SubscribeURL” and make a GET call to the included in the subscription confirmation message.
            5. If the endpoint configured for receiving webhooks requires authentication, follow these additional steps:
               * On receiving subscription confirmation message, first return an HTTP 401 status code with the response header as WWW-Authenticate = Basic
                 * Then proceed with the GET call to the “SubscribeURL”
                   6. Once subscription is confirmed, you will begin receiving the webhooks at the configured endpoint, within 1-1.5 hours..
                      <br />
                      Sample code to GET the Subscribed URL is mentioned below
                      <br />
                      ```
                      ```
                      <br />

## 5.2. Instant Webhook Events & Their Payload
